...
export const hotelList = [
    ...
    // ===== 武雄温泉（佐賀）=====
    {
        ...
        prefecture: 'saga',
        type: '老舗温泉旅館',
        description: '重要文化財の武雄温泉楼門から近い、武雄温泉を代表する老舗旅館。ナトリウム炭酸水素塩泉の美肌の湯は武雄神社の御神木・大クスノキの霊気が宿る名湯として親しまれる。夕食は佐賀の旬食材・佐賀牛の陶板焼き・有明海の海の幸・呼子産のイカを使った会席と地酒「天吹」の組み合わせが武雄温泉の歴史ある雰囲気とともに旅を豊かにする。',
        price: '2食付き 25,000円〜',
        image: './hotels/takeoonsenryokantouyoukan.png',
        tags: ['重要文化財・楼門の近く', '佐賀牛の陶板焼き', '美肌の名湯'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-saga-2-2',
        ...
        prefecture: 'saga',
        type: '温泉旅館',
        description: '武雄温泉の自然に囲まれた閑静な旅館。ナトリウム炭酸水素塩泉の柔らかな美肌の湯を源泉掛け流しで楽しめる宿。夕食は佐賀の食材を使った会席料理で、佐賀牛のしゃぶしゃぶ・有明海のタイラギ・呼子の活イカ料理が旅人の食欲を満たし、近年整備された武雄市図書館・重要文化財の温泉施設と組み合わせた武雄観光に最適な宿として評価されている。',
        price: '2食付き 20,000円〜',
        image: './hotels/ryokansuimeisou.png',
        tags: ['源泉掛け流し', '呼子の活イカ料理', '武雄観光の拠点'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-saga-2-3',
        ...
        prefecture: 'saga',
        type: '温泉旅館',
        description: '武雄温泉の豊かな自然の中に佇む温泉旅館。ナトリウム炭酸水素塩泉の美肌の湯を源泉掛け流しで提供し、露天風呂から武雄の山並みが望める。夕食は佐賀の旬食材を使った創作和食会席で、有明海の珍魚・タイラギの刺身・有明海産の海苔を使った料理・佐賀牛の料理が佐賀の食の豊かさを伝え、武雄温泉楼門と大楠観光と組み合わせた旅プランに最適。',
        price: '2食付き 22,000円〜',
        image: './hotels/buruubirayasuzousato.png',
        tags: ['源泉掛け流し', '有明海の珍魚料理', '武雄の大楠近接'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    ...
    // ===== 小浜温泉（長崎）=====
    {
        ...
        prefecture: 'nagasaki',
        type: '老舗温泉旅館',
        description: '橘湾を一望する絶景の小浜温泉の老舗旅館。日本一熱い源泉（105度）を誇る炭酸水素塩泉の湯は、橘湾の絶景を望む露天風呂で楽しめる。夕食は島原半島の旬食材・長崎和牛のしゃぶしゃぶ・小浜温泉名物の「ちゃんぽん」鍋・橘湾の旬魚を使った長崎会席と地酒「六十余洲」の組み合わせが旅情を高める。',
        price: '2食付き 25,000円〜',
        image: './hotels/obamaonsenryokanchijiwa.png',
        tags: ['日本一熱い源泉105度', '橘湾の絶景', '長崎ちゃんぽん鍋'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-nagasaki-2-2',
        ...
        prefecture: 'nagasaki',
        type: '温泉旅館',
        description: '小浜温泉の湧出量と温度が日本一を誇る名湯の温泉宿。105度の源泉を使ったスチーム料理「温泉蒸し」が名物で、炭酸水素塩泉の豊富な湯量を誇る内湯と露天風呂から橘湾の絶景が楽しめる。夕食は温泉蒸しで調理した島原の旬野菜・長崎和牛・橘湾の海の幸が独創的な料理として食卓を彩り、小浜温泉ならではの食体験が旅の記憶に深く刻まれる。',
        price: '2���付き 22,000円〜',
        image: './hotels/yuyadojoukiya.png',
        tags: ['温泉スチーム料理', '日本一の湯量・高温源泉', '橘湾の絶景露天風呂'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-nagasaki-2-3',
        ...
        prefecture: 'nagasaki',
        type: '温泉ホテル',
        description: '橘湾の海岸沿いに建つ温泉ホテル。小浜温泉の炭酸水素塩泉を大浴場と露天風呂で楽しめ、橘湾の海景色が360度広がる開放的な湯浴みが旅の気分を高める。夕食は長崎・島原半島の食材を使った会席料理で、橘湾の旬魚・長崎和牛・島原の地野菜・長崎名物のカステラを使ったデザートが旅人の食欲を満たし、雲仙温泉との組み合わせ旅行に最適の宿。',
        price: '2食付き 20,000円〜',
        image: './hotels/obamaonsenhoterumarin.png',
        tags: ['橘湾の海景色', '島原半島の食材', '雲仙観光の拠点'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    ...
    // ===== 人吉温泉（熊本）=====
    {
        ...
        prefecture: 'kumamoto',
        type: '老舗温泉旅館',
        description: '日本三急流の一つ・球磨川のほとりに建つ人吉温泉の代表的な老舗旅館。アルカリ性単純温泉の柔らかな湯は美肌効果で知られ、球磨川を眺める露天風呂が名物。夕食は人吉球磨の旬食材・球磨川の天然鮎の塩焼き・球磨牛のしゃぶしゃぶ・球磨焼酎を使った料理が球磨の大自然の豊かさを体感できる会席として旅情を高める。',
        price: '2食付き 22,000円〜',
        image: './hotels/hitoyoshiryokan.png',
        tags: ['球磨川沿いの老舗', '球磨川の天然鮎', '球磨牛しゃぶしゃぶ'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-kumamoto-2-2',
        ...
        prefecture: 'kumamoto',
        type: '温泉旅館',
        description: '人吉温泉の中心部に位置する温泉旅館。アルカリ性単純温泉の清澄な湯を源泉掛け流しで楽しめる。夕食は人吉球磨の旬食材・球磨焼酎を使った料理・球磨川の鮎・球磨牛の陶板焼き・きな粉を使った球磨の郷土料理が女将の手で丁寧に仕上げられ、球磨川ラフティングや武家屋敷観光と組み合わせた人吉の旅の拠点として旅行者に利用されている。',
        price: '2食付き 18,000円〜',
        image: './hotels/watanaberyokan.png',
        tags: ['源泉掛け流し', '球磨焼酎の料理', '人吉観光の拠点'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-kumamoto-2-3',
        ...
        prefecture: 'kumamoto',
        type: '温泉旅館',
        description: '球磨川の清流と人吉盆地の山並みに囲まれた温泉旅館。アルカリ性単純温泉の柔らかな湯を内湯と露天風呂で楽しみながら、人吉の大自然の中でゆったりした時間を過ごせる。夕食は球磨の旬食材・球磨川の鮎の塩焼き・球磨牛のすき焼き・地元農家から届く旬野菜・球磨焼酎の蒸し料理が人吉球磨の食文化を体験できる会席として評判を呼んでいる。',
        price: '2食付き 20,000円〜',
        image: './hotels/hitoyoshionsenshoukaku.png',
        tags: ['球磨川の自然', '球磨牛のすき焼き', '球磨焼酎蒸し料理'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    ...
    // ===== 長湯温泉（大分）=====
    {
        ...
        prefecture: 'oita',
        type: '老舗温泉旅館',
        description: 'ドイツの温泉地バーデンバーデンと姉妹都市の竹田市が誇る長湯温泉の老舗旅館。日本有数の高濃度炭酸泉は体内に炭酸ガスが浸透し血行促進・高血圧・心臓病に効能を持つ世界レベルの療養泉。芹川の清流を望む露天風呂で長湯を楽しみながら、夕食は大分の食材・豊後牛のしゃぶしゃぶ・竹田の清水湧水で育てた野菜を使った会席が旅の滋養となる。',
        price: '2食付き 25,000円〜',
        image: './hotels/nagayuonsenryokandaimaruryokan.png',
        tags: ['日本最高濃度の炭酸泉', 'バーデンバーデン姉妹都市', '豊後牛しゃぶしゃぶ'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-oita-4-2',
        ...
        prefecture: 'oita',
        type: '温泉旅館',
        description: '長湯温泉の中心部に建つ歴史ある温泉旅館。日本有数の高濃度炭酸泉を源泉掛け流しで楽しめる内湯と露天風呂は、芹川のほとりで長湯入浴を楽しむ旅人に愛されてきた。夕食は竹田・大分の旬食材・豊後牛のすき焼き・大分県産のしいたけ・椎茸・竹田産の天然米を使った会席料理が長湯温泉の歴史と療養文化とともに旅の充実感を高める。',
        price: '2食付き 20,000円〜',
        image: './hotels/nagayuonsenomaeyu.png',
        tags: ['源泉掛け流しの炭酸泉', '芹川の渓谷', '豊後牛のすき焼き'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
    {
        id: 'h-oita-4-3',
        ...
        prefecture: 'oita',
        type: '温泉旅館',
        description: '「ラムネ温泉」として親しまれる長湯温泉の高濃度炭酸泉を源泉掛け流しで楽しめる旅館。入浴するとシュワシュワと体に泡が付く日本唯一級の炭酸泉体験は世界的にも珍しい。夕食は大分の食材を使った会席料理で、豊後牛のすき焼き・大分産のかぼすを使ったドレッシング・しいたけの炭火焼きが炭酸泉の滋養とともに旅人の体を内側から活性化する。',
        price: '2食付き 18,000円〜',
        image: './hotels/nagayuonsenramuneonsenkanryokan.png',
        tags: ['体に泡が付く高濃度炭酸泉', '日本有数の炭酸泉', 'かぼすの料理'],
        bookingUrls: { jalan: '#', rakuten: '#', ikyu: '#', yahoo: '#' }
    },
